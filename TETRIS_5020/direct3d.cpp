...
IDXGISwapChain*         Direct3D::swap_chain_;         // スワップチェーンフェイス
...
void Direct3D::clear()
{
    float color[] = { 0.0F,0.0F,0.0F,0.0F };  // RGBAを0.0～1.0の間で設定
